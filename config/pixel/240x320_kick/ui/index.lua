...
local ____Sample2View = require("config.pixel.240x320_kick.ui.Sample.Sample2View")
local Sample2View = ____Sample2View.Sample2View
local ____SampleView = require("config.pixel.240x320_kick.ui.Sample.SampleView")
