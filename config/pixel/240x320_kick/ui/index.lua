...
local ____mainView = require("config.pixel.240x320_kick.ui.mainView.index")
local MainView = ____mainView.MainView
...
applyZic(React.createElement(MainView, {name = "Home"}))
return ____exports
