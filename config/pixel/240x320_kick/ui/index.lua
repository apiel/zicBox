...
local ____Clap2View = require("config.pixel.240x320_kick.ui.Clap.Clap2View")
local Clap2View = ____Clap2View.Clap2View
local ____ClapView = require("config.pixel.240x320_kick.ui.Clap.ClapView")
local ClapView = ____ClapView.ClapView
...
applyZic(React.createElement(ClapView, {name = "Clap"}))
applyZic(React.createElement(Clap2View, {name = "Clap2"}))
