...
local ____Bass2View = require("config.pixel.240x320_kick.ui.303.Bass2View")
local Bass2View = ____Bass2View.Bass2View
local ____BassView = require("config.pixel.240x320_kick.ui.303.BassView")
...
applyZic(React.createElement(Bass2View, {name = "Bass2"}))
