...
local ____ResonatorView = require("config.pixel.240x320_kick.ui.Drum23.ResonatorView")
local ResonatorView = ____ResonatorView.ResonatorView
...
applyZic(React.createElement(ResonatorView, {name = "Resonator"}))
