...
local ____kickView = require("config.pixel.240x320_kick.ui.kickView.index")
local KickView = ____kickView.KickView
...
applyZic(React.createElement(KickView, {name = "Home"}))
return ____exports
