...
local drum23 = require("config/pixel/320x170/audio/drum23_track")
local drumSample = require("config/pixel/320x170/audio/drumSample_track")
local fm = require("config/pixel/320x170/audio/fm_track")
