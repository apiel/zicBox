...
export const bounds1mini = [0, topMini, W1_4 - 2, 24];
export const bounds2mini = [W1_4, topMini, W1_4 - 2, 24];
export const bounds3mini = [W1_4 * 2, topMini, W1_4 - 2, 24];
export const bounds4mini = [W1_4 * 3, topMini, W1_4 - 2, 24];
export const bounds5mini = [0, topMini + 40, W1_4 - 2, 24];
export const bounds6mini = [W1_4, topMini + 40, W1_4 - 2, 24];
export const bounds7mini = [W1_4 * 2, topMini + 40, W1_4 - 2, 24];
export const bounds8mini = [W1_4 * 3, topMini + 40, W1_4 - 2, 24];
export const bounds9mini = [0, topMini + 80, W1_4 - 2, 24];
export const bounds10mini = [W1_4, topMini + 80, W1_4 - 2, 24];
export const bounds11mini = [W1_4 * 2, topMini + 80, W1_4 - 2, 24];
export const bounds12mini = [W1_4 * 3, topMini + 80, W1_4 - 2, 24];
