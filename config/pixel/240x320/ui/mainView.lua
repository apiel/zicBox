...
local function encoders(group, track, y)
    ...
    value("DrumSample START", { x = 0, y = 12, w = W2_4 - 2, h = valueH },
    ...
    value("DrumSample END", { x = W2_4, y = 12, w = W2_4 - 2, h = valueH },
    ...
    value("Sequencer STEP_VELOCITY", { x = 0, y = 0, w = W2_4 - 2, h = valueH },
        { LABEL_COLOR = "tertiary", BAR_COLOR = TertiaryBar, ENCODER_ID = 0, TRACK = track, GROUP = group })
    value("Sequencer STEP_CONDITION", { x = 0, y = 12, w = W2_4 - 2, h = valueH },
        { LABEL_COLOR = "primary", BAR_COLOR = PrimaryBar, ENCODER_ID = 1, TRACK = track, GROUP = group })
    ...
    -- value("Volume VOLUME", { x = W2_4, y = 12, w = W2_4 - 2, h = valueH },
    --     { LABEL_COLOR = "quaternary", BAR_COLOR = QuaternaryBar, ENCODER_ID = 3, TRACK = track, GROUP = group })
end
...
local function encodersMaster(group, track, y)
    ...
    value("VolumeDrive VOLUME", { x = 0, y = 0, w = W2_4 - 2, h = valueH },
        { LABEL_COLOR = "tertiary", BAR_COLOR = TertiaryBar, ENCODER_ID = 0, TRACK = track, GROUP = group })
    value("VolumeDrive DRIVE", { x = 0, y = 12, w = W2_4 - 2, h = valueH },
        { LABEL_COLOR = "primary", BAR_COLOR = PrimaryBar, ENCODER_ID = 1, TRACK = track, GROUP = group })
    ...
    value("MMFilter RESONANCE", { x = W2_4, y = 12, w = W2_4 - 2, h = valueH },
        { LABEL_COLOR = "quaternary", BAR_COLOR = QuaternaryBar, ENCODER_ID = 3, TRACK = track, GROUP = group })
end
