...
function ____exports.SaveTapeView(____bindingPattern0)
    ...
    return React.createElement(
        ...
        React.createElement(TextGrid, {bounds = KeyInfoPositionCenter, rows = {"Type &icon::arrowUp::filled Cancel", "&icon::arrowLeft::filled &icon::arrowDown::filled &icon::arrowRight::filled"}})
    )
end
return ____exports
