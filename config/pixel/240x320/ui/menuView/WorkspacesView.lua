...
function ____exports.WorkspacesView(____bindingPattern0)
    ...
    return React.createElement(
        ...
        React.createElement(
            TextGrid,
            {bounds = KeyInfoPositionCenter, rows = {"&empty &icon::arrowUp::filled ...", "Use &icon::arrowDown::filled Exit"}},
        ...
        React.createElement(
            TextGrid,
            {bounds = KeyInfoPositionCenter, rows = {"New &empty ^...", "&empty &empty &icon::trash"}},
