...
local ____DrumEnvelop = require("config.libs.nativeComponents.DrumEnvelop")
...
local ____Log = require("config.libs.nativeComponents.Log")
local Log = ____Log.Log
local ____Rect = require("config.libs.nativeComponents.Rect")
local Rect = ____Rect.Rect
local ____Spectrogram = require("config.libs.nativeComponents.Spectrogram")
