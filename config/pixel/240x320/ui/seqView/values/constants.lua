...
____exports.valueH = 29
____exports.rowSpacing = 8
____exports.height = 65
____exports.posY = 84
____exports.encoderH = 50
____exports.topLeft = {0, 0, W2_4 - 2, ____exports.valueH}
...
____exports.posContainerValues = {0, ____exports.posY, ScreenWidth, ____exports.valueH * 2 + 2}
