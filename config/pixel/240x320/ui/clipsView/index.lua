...
local ____Clips = require("config.pixel.240x320.ui.clipsView.Clips")
...
function ____exports.ClipsView(____bindingPattern0)
    ...
    return React.createElement(
        ...
        React.createElement(Clips, {color = ColorTrack5, track = 5, group = 3}),
        React.createElement(Clips, {color = ColorTrack6, track = 6, group = 4}),
        React.createElement(Clips, {color = ColorTrack7, track = 7, group = 4}),
        React.createElement(Clips, {color = ColorTrack8, track = 8, group = 5})
    )
end
return ____exports
