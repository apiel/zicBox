...
local ____BassView = require("config.pixel.240x320_kick copy.ui.Bass.BassView")
local BassView = ____BassView.BassView
local ____DistortionView = require("config.pixel.240x320_kick copy.ui.Bass.DistortionView")
local BassDistortionView = ____DistortionView.BassDistortionView
local ____EnvView = require("config.pixel.240x320_kick copy.ui.Bass.EnvView")
local BassEnvView = ____EnvView.BassEnvView
local ____SeqView = require("config.pixel.240x320_kick copy.ui.Bass.SeqView")
local BassSeqView = ____SeqView.BassSeqView
local ____WaveformView = require("config.pixel.240x320_kick copy.ui.Bass.WaveformView")
local BassWaveformView = ____WaveformView.BassWaveformView
local ____ClipsView = require("config.pixel.240x320_kick copy.ui.clipsView.ClipsView")
...
local ____AmpView = require("config.pixel.240x320_kick copy.ui.Drum23.AmpView")
local AmpView = ____AmpView.AmpView
local ____ClickView = require("config.pixel.240x320_kick copy.ui.Drum23.ClickView")
local ClickView = ____ClickView.ClickView
local ____DistortionView = require("config.pixel.240x320_kick copy.ui.Drum23.DistortionView")
local DistortionView = ____DistortionView.DistortionView
local ____Drum23View = require("config.pixel.240x320_kick copy.ui.Drum23.Drum23View")
local Drum23View = ____Drum23View.Drum23View
local ____FrequencyView = require("config.pixel.240x320_kick copy.ui.Drum23.FrequencyView")
local FrequencyView = ____FrequencyView.FrequencyView
local ____SeqView = require("config.pixel.240x320_kick copy.ui.Drum23.SeqView")
local Drum23SeqView = ____SeqView.Drum23SeqView
local ____WaveformView = require("config.pixel.240x320_kick copy.ui.Drum23.WaveformView")
local WaveformView = ____WaveformView.WaveformView
local ____CreateWorkspaceView = require("config.pixel.240x320_kick copy.ui.menu.CreateWorkspaceView")
local CreateWorkspaceView = ____CreateWorkspaceView.CreateWorkspaceView
local ____menuView = require("config.pixel.240x320_kick copy.ui.menu.menuView")
local MenuView = ____menuView.MenuView
local ____ShutdownView = require("config.pixel.240x320_kick copy.ui.menu.ShutdownView")
local ShutdownView = ____ShutdownView.ShutdownView
local ____WorkspacesView = require("config.pixel.240x320_kick copy.ui.menu.WorkspacesView")
local WorkspacesView = ____WorkspacesView.WorkspacesView
local ____SampleEditorView = require("config.pixel.240x320_kick copy.ui.Sample.SampleEditorView")
local SampleEditorView = ____SampleEditorView.SampleEditorView
local ____SaveTapeView = require("config.pixel.240x320_kick copy.ui.tapeView.SaveTapeView")
local SaveTapeView = ____SaveTapeView.SaveTapeView
local ____TapeView = require("config.pixel.240x320_kick copy.ui.tapeView.TapeView")
