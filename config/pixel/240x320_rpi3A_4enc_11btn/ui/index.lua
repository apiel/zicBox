...
local ____PercFmView = require("config.pixel.240x320_rpi3A_4enc_11btn.ui.Perc.PercFmView")
local PercFmView = ____PercFmView.PercFmView
...
applyZic(React.createElement(PercFmView, {name = "PercFm"}))
