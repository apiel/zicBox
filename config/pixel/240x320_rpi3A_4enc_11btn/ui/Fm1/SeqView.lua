...
function ____exports.Fm1SeqView(____bindingPattern0)
    local name
    ...
    return React.createElement(
        ...
        React.createElement(
            TextGrid,
            {bounds = KeyInfoPosition, rows = {"&icon::toggle::rect &icon::arrowUp::filled ...", "Seq./Bass &icon::arrowDown::filled &icon::musicNote::pixelated"}, ITEM_BACKGROUND = ColorTrack3},
        ...
        React.createElement(Common, {selected = "Fm1", hideSequencer = true, track = Fm1Track, selectedBackground = ColorTrack3})
    )
end
return ____exports
