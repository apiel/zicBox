...
local ____Clips = require("config.pixel.240x320_rpi3A_4enc_11btn.ui.clipsView.Clips")
local Clips = ____Clips.Clips
local ____TextGrid = require("config.pixel.240x320_rpi3A_4enc_11btn.ui.clipsView.TextGrid")
local TextGridClips = ____TextGrid.TextGridClips
local TextGridClipsShifted = ____TextGrid.TextGridClipsShifted
local ____Values = require("config.pixel.240x320_rpi3A_4enc_11btn.ui.clipsView.Values")
