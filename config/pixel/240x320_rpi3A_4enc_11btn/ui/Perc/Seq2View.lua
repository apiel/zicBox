...
local ____Sequencer = require("config.libs.components.Sequencer")
...
function ____exports.PercSeq2View(____bindingPattern0)
    ...
    return React.createElement(
        View,
        {name = name},
        React.createElement(Sequencer, {position = {0, 0, ScreenWidth, 240}, track = PercTrack}),
        React.createElement(
            TextGrid,
            {position = KeyInfoPosition, rows = {"&icon::toggle::rect &icon::arrowUp::filled ...", "Seq./Perc &icon::arrowDown::filled &icon::musicNote::pixelated"}, ITEM_BACKGROUND = ColorTrack3},
