...
async function explainCode(filePath) {
    ...
    const systemPrompt = `You are an expert ${language} code analyst and technical writer. Your task is to provide a comprehensive, structured explanation of the provided code for a Retrieval-Augmented Generation (RAG) system.

**Instructions for the analysis:**
1.  **Analyze and Explain:** Describe the purpose, main functions, and key algorithms used in the code.
2.  **Structure:** Format the output as a single, detailed markdown block, including the language name in the title.
3.  **Conciseness:** Ensure the explanation is clear, accurate, and ready to be indexed for retrieval.`;
