...
int main()
{
    logInfo("Starting zicKick Application (Wavetable Kick Synth)");

    snd_pcm_t* pcm_h = audioInit();
    pthread_setname_np(pthread_self(), "zicKick_UI");

    UiKick ui(worker);

    std::thread aThread(audioThreadLoop, pcm_h);
    pthread_setname_np(aThread.native_handle(), "zicKick_Audio");
    ...
    Styles appStyles = {
        ...
        .margin = 4,
        .colors = {
            .background = { 15, 17, 26, 255 },     // Deep dark navy/slate
            .white = { 255, 255, 255, 255 },
            .text = { 210, 222, 240, 255 },         // Soft blue-gray text
            .primary = { 0, 220, 255, 255 },        // Vibrant Cyan
            .secondary = { 255, 160, 40, 255 },     // Golden Amber
            .tertiary = { 255, 75, 105, 255 },      // Coral Pink
            .quaternary = { 28, 34, 52, 255 }       // Card Container Fill
        }
    };
    ...
    logInfo("zicKick shutdown cleanly.");
    return 0;
}
