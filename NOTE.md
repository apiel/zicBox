- TODO send note on track using global function... so that when triggering a note from a component or keyboard, there no need to specify target plugin...

- TODO kick23 apply amp envelop on filter or could even have his own envelop...
