...
export const KeyInfoPosition = [0, 294, W3_4];
...
export const ColorTrack1 = '#fd6f0e';
export const ColorTrack2 = '#ffcd04';
export const ColorTrack3 = '#a3c912';
export const ColorTrack4 = '#23a123';
