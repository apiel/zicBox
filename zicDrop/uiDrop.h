...
public:
    ...
    UiDrop(SequenceBrain& b, Drop& a) : brain(b), audio(a) {
        ...
        knobs.push_back({"VCO2 LEVEL", &audio.synthVco2Level.value, 0.0f, 1.0f, 1245.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_SYNTH, 0});
        knobs.push_back({"VCO2 DETUNE", &audio.synthVco2Detune.value, -24.0f, 24.0f, 1355.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_SYNTH, 0});
        ...
        knobs.push_back({"VCO2 FM", &audio.synthVco2Fm.value, 0.0f, 1.0f, 1245.0f, 280.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_SYNTH, 0});
