...
public:
    ...
    UiDrop(SequenceBrain& b, Drop& a) : brain(b), audio(a) {
        ...
        knobs.push_back({"VCO2 LVL", &audio.kickVco2Level.value, 0.0f, 1.0f, 410.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_KICK});
        knobs.push_back({"VCO2 HARM", &audio.kickVco2Harm.value, 1.0f, 12.0f, 500.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "x", SECTION_KICK});
        knobs.push_back({"VCO2 MRP", &audio.kickVco2Morph.value, 0.0f, 1.0f, 590.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_KICK});
        knobs.push_back({"CLICK AMT", &audio.kickClickAmt.value, 0.0f, 1.0f, 680.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_KICK});

        knobs.push_back({"CLICK DEC", &audio.kickClickDecay.value, 2.0f, 200.0f, 320.0f, 280.0f, 22.0f, false, 0.0f, 0.0f, " ms", SECTION_KICK});
        knobs.push_back({"KICK DRV", &audio.kickDrive.value, 0.0f, 1.0f, 410.0f, 280.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_KICK});
        ...
        knobs.push_back({"DRIVE", &audio.synthDrive.value, 0.0f, 1.0f, 1230.0f, 190.0f, 22.0f, false, 0.0f, 0.0f, "", SECTION_SYNTH, 0});
