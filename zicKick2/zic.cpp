...
int main()
{
    logInfo("Starting zicKick2 Application (Potentiometer Wavetable Kick Synth)");

    snd_pcm_t* pcm_h = audioInit();
    pthread_setname_np(pthread_self(), "zicKick2_UI");

    UiKick ui(worker);

    std::thread aThread(audioThreadLoop, pcm_h);
    pthread_setname_np(aThread.native_handle(), "zicKick2_Audio");
    ...
    Styles appStyles = {
        ...
        .margin = 4,
        .colors = {
            .background = { 15, 17, 26, 255 },
            .white = { 255, 255, 255, 255 },
            .text = { 210, 222, 240, 255 },
            .primary = { 0, 220, 255, 255 },
            .secondary = { 255, 160, 40, 255 },
            .tertiary = { 255, 75, 105, 255 },
            .quaternary = { 28, 34, 52, 255 }
        }
    };
    ...
    logInfo("zicKick2 shutdown cleanly.");
    return 0;
}
