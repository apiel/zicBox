...
public:
    ...
    void initParticles()
    {
        ...
        for (int i = 0; i < numParticles; ++i) {
            ...
            float x = (rand() % 480) - 240.0f;
            float y = (rand() % 300) - 150.0f;
    ...
    void updateAndDraw(Draw& d, float bpm, float drive, int startX, int startY, int viewW, int viewH)
    {
        ...
        float speedMult = (bpm / 120.0f) * 3.5f;
