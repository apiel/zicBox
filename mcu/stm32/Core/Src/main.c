...
extern void Display_TimerCallback(void);
/* USER CODE END 0 */
 ...
 * Called automatically when any timer overflow occurs
 */
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == TIM7) {
        // Display update timer (20 Hz)
        Display_TimerCallback();
    }
    // Add other timers here if needed
}
/* USER CODE END 4 */
